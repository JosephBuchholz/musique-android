...
public:
    ...
    Note* tiedNote = nullptr; // the note that this tie is tied to (if tie type is start then the note is the second note; if tie type is end then the note is the first note).
