...
private:
    ...
    static std::string GetStringValue(const std::string& elementName, XMLElement* elementParent, std::string defaultValue = "");
    static float GetFloatValue(XMLElement* element, float defaultValue = 0.0f);
    static float GetFloatValue(const std::string& elementName, XMLElement* elementParent, float defaultValue = 0.0f);
